        ...
        <div class="layout-container">
            ...
            <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
                ...
                <ul class="menu-inner py-1">
                    ...
                    <!-- Daftar Pertandingan -->
                    <li class="menu-item {{ Request::is('daftar-pertandingan') ? 'active' : '' }}">
                        <a href="{{ url('daftar-pertandingan') }}" class="menu-link">
                            <i class='menu-icon tf-icons bx bx-calendar-event'></i>
                            <div data-i18n="Basic">Daftar Pertandingan</div>
                        </a>
                    </li>
                    ...
                    <li class="menu-item {{ Request::is('penjualan-tiket') ? 'active' : '' }}">
                        <a href="{{ url('penjualan-tiket') }}" class="menu-link">
                            <i class="menu-icon tf-icons bx bx-task"></i>
                            <div data-i18n="Basic">Daftar Penjualan Tiket</div>
                        </a>
                    </li>
                        ...
                        <ul class="navbar-nav flex-row align-items-center ms-auto">
                            ...
                            <li class="nav-item navbar-dropdown dropdown-user dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end">
                                    ...
                                    <li>
                                        <a class="dropdown-item" href="{{ url('profile-seller') }}">
